...
const config: Config = {
  ...
  themeConfig: {
    ...
    navbar: {
      title: "microfern",
      logo: {
        alt: "microfern logo, a fern leaf and the word microfern, leaf is a lighter green and the word is a darker green",
        src: "img/logo.svg",
      },
      items: [
        {
    ...
    footer: {
      style: "dark",
      copyright: `microfern docs. MIT / CC-BY. built with docusaurus.`,
    },
    prism: {
